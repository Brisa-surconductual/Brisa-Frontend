...
import {
  EmptyScheduleState,
} from '@/features/cronograma/components/EmptyScheduleState/index.js';
import {
  ScheduleFilters,
} from '@/features/cronograma/components/ScheduleFilters/index.js';
import {
  TemporalUnitList,
} from '@/features/cronograma/components/TemporalUnitList/index.js';
...
export function ScheduleManagementPage() {
  ...
  function handleViewDetails(unitId) {
    navigate(
      `/app/administrativo/cronograma/${encodeURIComponent(
        unitId,
      )}`,
    );
  }
